...
which zip codes are in zip but not zori? use "illustrative examples" to discuss why they may have been excluded

Table:
- compare jan 2021 rental prices to jan 2020
  - make a difference variable and sort by it
- make a table with the 10 zip codes (+ boro and neighborhood) with largest drop in price from jan 2020 to jan 2021
- comment